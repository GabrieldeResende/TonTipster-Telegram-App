  ...
  return (
    ...
    className="bg-black text-white p-4 h-screen">
      <div className="font-bold bg-[var(--primary-purple)] p-2 rounded-lg">
        <h2 className='text-[13px] text-center font-semibold text-gray-300'>Previous Bets</h2>
      </div>
          ...
          <div key={index} className='border border-gray-800 bg-[#1F2937] rounded-lg p-4 mb-2 w-full'>
            ...
            <div className='flex items-center justify-between text-sm'>
              <div className="flex items-center">
                ...
                <p className="text-[#4AD77E] ml-1">{bet.status}</p>
              </div>
              <div className="flex items-center">
                <p className="text-[#4AD77E] ml-1">{`+${bet.potentialWinnings}`}</p>
              </div>
            </div>
            <div>
                <div className="text-sm text-[#D5B3FB] mt-2">
                    <p>{`Won against: ${bet.participants[0].name}`}</p>
                </div>
            </div>
          </div>
        ))}
